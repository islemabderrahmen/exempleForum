...
class MediaVideo
{
    ...
    private function youtubeId($url)
    {
        ...
        $this->setTypeVideo('youtube');  // signale qu’il s’agit d’une video youtube et l’inscrit dans l’attribut $type
    }
    ...
    private function dailymotionId($url)
    {
        ...
        $this->setTypeVideo('dailymotion'); // signale qu’il s’agit d’une video dailymotion et l’inscrit dans l’attribut $type
    }
    ...
    private function vimeoId($url)
    {
        ...
        $this->setTypeVideo('vimeo');  // signale qu’il s’agit d’une video vimeo et l’inscrit dans l’attribut $type
   ...
   */
    ...
    {
        $control = $this->getTypeVideo();  // on récupère le type de la vidéo
